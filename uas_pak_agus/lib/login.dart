...
class _LoginState extends State<Login> {
  ...
  Future<List> _login() async {
    final response = await http.post(
        'http://192.168.43.128/apiflutter/api/Login/login_api',
  ...
  savePref(
      String email, String name, String id, int level, String photo) async {
